...
export const sourceGroups = [
  {
    ...
    body: 'AI runs inside data centers, and data centers draw from local grids. The strongest estimates point to rapid growth, but the climate effect depends on when and where that electricity is generated.',
    signal: 'High confidence',
    source: 'US Department of Energy · Berkeley Lab, 2024',
    href: 'https://escholarship.org/uc/item/32d6m0d1',
  },
  {
    id: 'climate',
    label: 'Climate',
    title: 'Carbon intensity changes the answer.',
    body: 'A model query is not a fixed amount of emissions. Hardware efficiency, utilization, cooling, grid mix, and whether new demand is matched with clean power all move the result.',
    signal: 'Important qualifier',
    source: 'International Energy Agency · Energy and AI, 2025',
    href: 'https://iea.blob.core.windows.net/assets/de9dea13-b07d-42c5-a398-d1b3ae17d866/EnergyandAI.pdf',
  },
  {
    id: 'water',
    label: 'Water',
  ...
  },
  {
    ...
    source: 'IEA · Energy and AI, sections on AI applications',
    href: 'https://www.iea.org/reports/energy-and-ai/ai-for-energy-optimisation-and-innovation',
  },
]
